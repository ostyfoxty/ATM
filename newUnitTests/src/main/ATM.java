...
public class ATM implements Iterable<Object>, Comparable<ATM>, Iterator<Object> {
    ...
    public int getX100(){return x100;}

    public int getX10(){return x10;}
    ...
    public void addMoney(int add100, int add50, int add20,int add10,int add5) {
        ...
        if(add100==0&&add50==0&&add20==0&&add10==0&&add5==0)
        {
            System.out.println("Why are you trying to add 0 banknotes?");
        }
        x100 +=add100;
        x50 +=add50;
        x20 +=add20;
     ...
     */
    public void askMoney(int requestCash) {

        if (account < requestCash) {
            System.out.print("Not enough money in ATM");
        } else if(requestCash>maxSum){
            System.out.print("You can't have so many money");
        }else if(requestCash<minSum){
            System.out.print("ATM doesn't have such little bills");
        }else  System.out.print("Take your money");
